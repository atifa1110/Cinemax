...
internal object Constants {
    ...
    internal const val VIDEO_URL = "https://www.youtube.com/watch?v="
    internal const val API_KEY_QUERY_PARAM = "api_key"
    internal const val PAGE_SIZE = 20
    internal const val DEFAULT_PAGE = 1

    internal object Path {
        internal const val SEARCH_MULTI = "search/multi"
        internal const val TRENDING_ALL = "trending/all/day"
        ...
        internal const val GENRE_MOVIE = "genre/movie/list"
    ...
    internal object Fields {
        ...
        internal val DETAILS_APPEND_TO_RESPONSE = buildAppendToResponse(CREDITS, IMAGES, VIDEOS)
        internal val DETAILS_APPEND_TO_RESPONSE_TV = buildAppendToResponse(CREDITS)
