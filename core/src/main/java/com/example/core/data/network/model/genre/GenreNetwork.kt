package com.example.core.data.network.model.genre
...
enum class GenreNetworkWithId(val genreName: String, val id: Int) {
    ...
    companion object {
        private val genres = entries.associateBy(GenreNetworkWithId::id)
